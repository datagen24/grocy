...
#
# This is a separate derivation rather than a file inside nix/approot.nix because it
# does not belong to the application: it lands at /etc, it exists only to satisfy
