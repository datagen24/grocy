...
| **Location barcodes**, aimed at camera-based inventory rather than phone scanning | draft — [plan 06](docs/plans/06-location-barcodes.md), narrowed by [ADR-0011](docs/adr/0011-label-namespace.md): labels carry opaque `vctl:` identifiers rather than row ids |
| **Observation intake** — cameras and sensors say what they think they saw, and a person confirms it before the ledger moves | decided, not built — [ADR-0012](docs/adr/0012-observations-are-proposals.md) (accepted 2026-09-04); no plan owns the work yet |
