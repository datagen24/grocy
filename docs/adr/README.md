...
- **[0015](0015-medication-records-never-advises.md) and
  [0016](0016-schedule-expansion-in-the-application.md) — the two medication records.**
  ...
  written the same day. Listed so they are not absent. 0015 carries two prerequisites, both
  reviews rather than builds; 0016 carries one open question that plan 22 piece 4 needs
  answered before it starts. 0016 is also **evidence against
